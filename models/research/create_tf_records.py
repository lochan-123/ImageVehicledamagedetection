...
def main(_):
    ...
    trainImagePath = "../research/object_detection/traindata/Test"
    trainImageJsonPath = "../research/object_detection/traindata/TestJson"
    labelMapPath = "../research/customtraining/labelmap.pbtxt"
    outputFolderPath = "../research/vechicle_test.record"
